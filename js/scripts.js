$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Matrimonio Pina e Max",

            // Event start date
            start: new Date('Jun 10, 2023 10:30'),
            ...
            end: new Date('Jun 11, 2023 00:00'),

            // Event Address
            address: 'Villa Florio Ricevimenti, San Nicandro Garganico',
...
// Countdown
(function () {
    var countDownDate = new Date("Jun 10, 2023 10:30:00").getTime();
    ...
    var x = setInterval(function() {
        ...
        // Output the result in the relative element
        ...
        if (distance < 0) {
            document.getElementById("announcement").innerText = "JUST MARRIED!";
